 ...
 */
class CountryTranslation extends \App\Entity\CountryTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CountryTranslation $proxy) {
