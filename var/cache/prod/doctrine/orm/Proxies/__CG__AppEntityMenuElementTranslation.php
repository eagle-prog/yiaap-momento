 ...
 */
class MenuElementTranslation extends \App\Entity\MenuElementTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'label', 'slug', 'id', 'locale', 'translatable'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MenuElementTranslation $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setLabel(string $label): \App\Entity\MenuElementTranslation
    {
