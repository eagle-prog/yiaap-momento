 ...
 */
class HelpCenterCategory extends \App\Entity\HelpCenterCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\HelpCenterCategory' . "\0" . 'id', 'translations', '' . "\0" . 'App\\Entity\\HelpCenterCategory' . "\0" . 'subcategories', '' . "\0" . 'App\\Entity\\HelpCenterCategory' . "\0" . 'parent', '' . "\0" . 'App\\Entity\\HelpCenterCategory' . "\0" . 'articles', '' . "\0" . 'App\\Entity\\HelpCenterCategory' . "\0" . 'icon', '' . "\0" . 'App\\Entity\\HelpCenterCategory' . "\0" . 'hidden', '' . "\0" . 'App\\Entity\\HelpCenterCategory' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\HelpCenterCategory' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\HelpCenterCategory' . "\0" . 'deletedAt', 'newTranslations', 'currentLocale', 'defaultLocale'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HelpCenterCategory $proxy) {
