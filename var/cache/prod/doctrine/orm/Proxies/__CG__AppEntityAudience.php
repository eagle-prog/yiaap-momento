 ...
 */
class Audience extends \App\Entity\Audience implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'id', 'translations', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'events', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'imageFile', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'imageName', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'imageSize', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'imageMimeType', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'imageOriginalName', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'imageDimensions', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'hidden', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\Audience' . "\0" . 'deletedAt', 'newTranslations', 'currentLocale', 'defaultLocale'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Audience $proxy) {
