 ...
 */
class VenueTypeTranslation extends \App\Entity\VenueTypeTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VenueTypeTranslation $proxy) {
