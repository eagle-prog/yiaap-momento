...
class Review extends \App\Entity\Review implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'event', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'user', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'rating', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'headline', 'slug', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'details', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'deletedAt', '' . "\0" . 'App\\Entity\\Review' . "\0" . 'visible'];
        }
