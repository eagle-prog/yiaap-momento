 ...
 */
class Amenity extends \App\Entity\Amenity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Amenity' . "\0" . 'id', 'translations', '' . "\0" . 'App\\Entity\\Amenity' . "\0" . 'venues', '' . "\0" . 'App\\Entity\\Amenity' . "\0" . 'icon', '' . "\0" . 'App\\Entity\\Amenity' . "\0" . 'hidden', '' . "\0" . 'App\\Entity\\Amenity' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\Amenity' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\Amenity' . "\0" . 'deletedAt', 'newTranslations', 'currentLocale', 'defaultLocale'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Amenity $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getVenues(): \Doctrine\Common\Collections\Collection
    {
     ...
     * {@inheritDoc}
     */
    public function addVenue(\App\Entity\Venue $venue)
    {
     ...
     * {@inheritDoc}
     */
    public function removeVenue(\App\Entity\Venue $venue)
    {
