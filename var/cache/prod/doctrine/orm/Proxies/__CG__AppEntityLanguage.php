...
class Language extends \App\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Language' . "\0" . 'id', 'translations', '' . "\0" . 'App\\Entity\\Language' . "\0" . 'events', '' . "\0" . 'App\\Entity\\Language' . "\0" . 'eventssubtitled', 'code', '' . "\0" . 'App\\Entity\\Language' . "\0" . 'hidden', '' . "\0" . 'App\\Entity\\Language' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\Language' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\Language' . "\0" . 'deletedAt', 'newTranslations', 'currentLocale', 'defaultLocale'];
        }
    ...
    public function getEventssubtitled()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEventssubtitled', []);

        return parent::getEventssubtitled();
    }
    ...
    public function addEventssubtitled($eventssubtitled)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEventssubtitled', [$eventssubtitled]);

        return parent::addEventssubtitled($eventssubtitled);
    }
    ...
    public function removeEventssubtitled($eventssubtitled)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeEventssubtitled', [$eventssubtitled]);

        return parent::removeEventssubtitled($eventssubtitled);
    }
