 ...
 */
class HelpCenterArticleTranslation extends \App\Entity\HelpCenterArticleTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'title', 'slug', 'content', 'tags', 'id', 'locale', 'translatable'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HelpCenterArticleTranslation $proxy) {
