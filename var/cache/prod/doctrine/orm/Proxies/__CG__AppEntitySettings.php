 ...
 */
class Settings extends \App\Entity\Settings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Settings' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Settings' . "\0" . 'key', '' . "\0" . 'App\\Entity\\Settings' . "\0" . 'value'];
        }
