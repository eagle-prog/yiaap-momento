 ...
 */
class HelpCenterArticle extends \App\Entity\HelpCenterArticle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\HelpCenterArticle' . "\0" . 'id', 'translations', '' . "\0" . 'App\\Entity\\HelpCenterArticle' . "\0" . 'category', '' . "\0" . 'App\\Entity\\HelpCenterArticle' . "\0" . 'views', '' . "\0" . 'App\\Entity\\HelpCenterArticle' . "\0" . 'hidden', '' . "\0" . 'App\\Entity\\HelpCenterArticle' . "\0" . 'featured', '' . "\0" . 'App\\Entity\\HelpCenterArticle' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\HelpCenterArticle' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\HelpCenterArticle' . "\0" . 'deletedAt', 'newTranslations', 'currentLocale', 'defaultLocale'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HelpCenterArticle $proxy) {
