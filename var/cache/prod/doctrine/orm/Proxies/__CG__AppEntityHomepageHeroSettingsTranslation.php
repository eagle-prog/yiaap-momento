 ...
 */
class HomepageHeroSettingsTranslation extends \App\Entity\HomepageHeroSettingsTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'title', 'paragraph', 'id', 'locale', 'translatable'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HomepageHeroSettingsTranslation $proxy) {
