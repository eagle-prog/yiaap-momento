...
class Country extends \App\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'id', 'translations', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'venues', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'events', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'organizers', 'code', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'hidden', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\Country' . "\0" . 'deletedAt', 'newTranslations', 'currentLocale', 'defaultLocale'];
        }
