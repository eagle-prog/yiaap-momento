 ...
 */
class HelpCenterCategoryTranslation extends \App\Entity\HelpCenterCategoryTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'slug', 'id', 'locale', 'translatable'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HelpCenterCategoryTranslation $proxy) {
