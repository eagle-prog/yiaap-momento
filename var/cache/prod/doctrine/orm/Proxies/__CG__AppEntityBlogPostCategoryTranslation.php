 ...
 */
class BlogPostCategoryTranslation extends \App\Entity\BlogPostCategoryTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BlogPostCategoryTranslation $proxy) {
