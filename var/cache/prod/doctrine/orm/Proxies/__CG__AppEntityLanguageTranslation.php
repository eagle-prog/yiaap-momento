 ...
 */
class LanguageTranslation extends \App\Entity\LanguageTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LanguageTranslation $proxy) {
