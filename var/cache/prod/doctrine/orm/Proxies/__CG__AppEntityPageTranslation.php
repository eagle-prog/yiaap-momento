 ...
 */
class PageTranslation extends \App\Entity\PageTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\PageTranslation' . "\0" . 'title', 'slug', 'content', 'id', 'locale', 'translatable'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageTranslation $proxy) {
