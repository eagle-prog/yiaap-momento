 ...
 */
class BlogPostCategory extends \App\Entity\BlogPostCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\BlogPostCategory' . "\0" . 'id', 'translations', '' . "\0" . 'App\\Entity\\BlogPostCategory' . "\0" . 'blogposts', '' . "\0" . 'App\\Entity\\BlogPostCategory' . "\0" . 'hidden', '' . "\0" . 'App\\Entity\\BlogPostCategory' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\BlogPostCategory' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\BlogPostCategory' . "\0" . 'deletedAt', 'newTranslations', 'currentLocale', 'defaultLocale'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BlogPostCategory $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addBlogpost(\App\Entity\BlogPost $blogpost)
    {
     ...
     * {@inheritDoc}
     */
    public function removeBlogpost(\App\Entity\BlogPost $blogpost)
    {
