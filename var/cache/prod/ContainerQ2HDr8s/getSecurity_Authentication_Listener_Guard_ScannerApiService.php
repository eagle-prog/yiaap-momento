...
// Returns the private 'security.authentication.listener.guard.scanner_api' shared service.
...
return $this->privates['security.authentication.listener.guard.scanner_api'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($a, ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'scanner_api', new RewindableGenerator(function () {
