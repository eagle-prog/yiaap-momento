...
return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () {
    ...
    yield 10 => ($this->privates['exercise_html_purifier.cache_warmer.serializer'] ?? $this->load('getExerciseHtmlPurifier_CacheWarmer_SerializerService.php'));
}, 11), false, ($this->targetDir.''.'/srcApp_KernelProdContainerDeprecations.log'));
